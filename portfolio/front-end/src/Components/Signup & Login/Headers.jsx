...
<div className='ms-auto d-flex column-gap-5 pt-2'>
        <NavLink to="/sign-up/investor" className="text-decoration-none text-white">Investor</NavLink>
        <NavLink to="/sign-up/wealth" className="text-decoration-none text-white">Wealth Proffesionals</NavLink>
        </div>
